define(['rx', 'ramda'],
  function(Rx, R) {
    ...
    var lens = function(path) {
      ...
      var _subj_observer = Rx.Observer.create(function(v) {
        var _root_val = _lens_setter(v, root.value || {});
        root.onNext(_root_val);
      }, function(err) {}, function() {});
      var _subj_observable = Rx.Observable.create(function(obs) {
      ...
      var lens_subj = Rx.Subject.create(_subj_observer, _subj_observable);
